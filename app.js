...
const primitiveTypes = new Set([
  ...
  "f16", "f32", "f64", "f80", "f128", "isize", "label", "Library", "Macro", "Matrix",
  "Namespace", "Pattern", "s8", "s16", "s32", "s64", "s128", "Simd", "string", "string16",
...
function constraintsAllow(signature, bindings) {
  ...
  const numeric = /^(?:isize|usize|[su][0-9]+|f(?:16|32|64|80|128))$/i;
  const floating = /^f(?:16|32|64|80|128)$/i;
  const integer = /^(?:isize|usize|[su][0-9]+)$/i;
